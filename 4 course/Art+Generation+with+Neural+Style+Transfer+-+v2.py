...
def compute_content_cost(a_C, a_G):
    ...
    J_content = (1/(n_W*n_H*n_C*4))*tf.reduce_sum(tf.square(tf.subtract(a_C,a_G)))
    ### END CODE HERE ###
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = (1/(4*(n_W**2)*(n_H**2)*(n_C**2)))*tf.reduce_sum(tf.square(tf.subtract(GS,GG)))
...
def total_cost(J_content, J_style, alpha = 10, beta = 40):
    ...
    ### START CODE HERE ### (≈1 line)
    J = J_content*alpha+beta*J_style
    ### END CODE HERE ###
